...
# AA ESI Status
from esistatus import __title__, __version__
...
@register.simple_tag
def esistatus_static(relative_file_path: str) -> str | None:
    """
    Versioned static URL

    :param relative_file_path: The file path relative to the `aa-esi-status/esistatus/static/esistatus` folder
    ...
    static_file_path = os.path.join("esistatus", relative_file_path)
