...
# Setup variables
project_name = "aa-esi-status"
project_description = "A simple status monitor for ESI."
project_license = "GPLv3"
project_author = "Peter Pfeufer"
project_author_email = "development@ppfeufer.de"
project_git_url = "https://github.com/ppfeufer/aa-esi-status/"
...
project_install_requirements = ["allianceauth>=2.9.4", "allianceauth-app-utils>=1.8.2"]
